...
function DashboardPage() {
  ...
  async function handleSubmit() {
    ...
    return (
    <div className="max-w-5xl mx-auto mt-12 px-6 grid md:grid-cols-3 gap-8">
      <div className="md:col-span-2 text-center">
        ...
        {result && (
          ...
          >
            ...
            <div className="border-l border-ink/10 pl-8 hidden md:block">
        <p className="font-mono-label text-xs uppercase text-signal mb-4">How It Works</p>
        <div className="space-y-5 text-sm text-ink/60">
          <div>
            <p className="font-medium text-ink mb-1">1. Upload</p>
            <p>Choose a photo, video, or voice recording from your device.</p>
          </div>
          <div>
            <p className="font-medium text-ink mb-1">2. We Check It</p>
            <p>We look for the subtle signs AI-generated or altered content leaves behind — things the human eye can't catch.</p>
          </div>
          <div>
            <p className="font-medium text-ink mb-1">3. Get Your Result</p>
            <p>You'll get a clear verdict — REAL, FAKE, or somewhere in between — with a confidence score you can trust.</p>
          </div>
        </div>
        <div className="mt-8 p-4 bg-white border border-ink/10 rounded-sm">
          <p className="text-xs text-ink/50 leading-relaxed">
            Tip: For best results with photos and video, use clear, well-lit
            footage of a face.
          </p>
        </div>
      </div>
